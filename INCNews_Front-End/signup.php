    ...
    <div class="column">
      ...
      <form class="ui large form">
        <div class="ui stacked segment">
          ...
          <div class="ui fluid small teal button RegisterDashboard">Register</div>
        </div>
      ...
      <div class="ui message">
        you want ? <a href="../INCNews_Front-End/login.php">Login</a>
      </div>
    </div>
  </div>
  <script src="../_js/global.js"></script>
  <script src="../INCNews_Front-End/_js/notif.js"></script>
  <script src="../INCNews_Front-End/_js/signup.js"></script>
</body>
